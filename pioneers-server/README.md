...
Just run container. Examples:
    ...
    docker run --rm -e PIONEERS_PORTS=7000-8000 -p 5557:5557 -p 7000-8000:7000-8000 duelafn/pioneers-server:deb13

    # Metaserver only (may still run server manually):
    docker run --rm -p 5557:5557 -p 7000-8000:7000-8000 duelafn/pioneers-server:deb13
